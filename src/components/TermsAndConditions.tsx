        ...
        <div className="space-y-12">
          ...
          <div className="bg-surface p-6 rounded-2xl shadow-lg border border-border backdrop-blur-md transition-all hover:shadow-xl">
            ...
            <p className="text-sm md:text-base text-textSecondary">
              ...
              or restrict their access to our services. Prohibited activities
              include unauthorized access, distribution of harmful content, or
          ...
          <div className="bg-surface p-6 rounded-2xl shadow-lg border border-border backdrop-blur-md transition-all hover:shadow-xl">
            ...
            <p className="text-sm md:text-base text-textSecondary">
              ...
              all activities conducted under your account. You must notify us
          ...
          <div className="bg-surface p-6 rounded-2xl shadow-lg border border-border backdrop-blur-md transition-all hover:shadow-xl">
            ...
            <p className="text-sm md:text-base text-textSecondary">
              ...
              designs, is the property of MedSupply or its licensors and is
          ...
          <div className="bg-surface p-6 rounded-2xl shadow-lg border border-border backdrop-blur-md transition-all hover:shadow-xl">
            ...
            <p className="text-sm md:text-base text-textSecondary">
              Any disputes arising from your use of our services will be
              resolved through negotiation or, if necessary, binding
              arbitration. We are not liable for any indirect, incidental, or
          ...
          <div className="bg-surface p-6 rounded-2xl shadow-lg border border-border backdrop-blur-md transition-all hover:shadow-xl">
            ...
            <p className="text-sm md:text-base text-textSecondary">
              ...
              of California, United States, without regard to its conflict of
              law principles. Any legal actions must be brought in the courts
              located in Medical City, California.
            </p>
          </div>
        </div>
